from operator import itemgetter #this imports itemgetter for sorting
...
def read_charges(charges_file): #takes the charges file as arguement

    charges = list()
    charges_dict = dict()

    for charge_string in open('new_charges_file'):
...
charges_list, charges_dict = read_charges("new_charges-file")
